const CSSSplitWebpackPlugin = require("./index");
const name = "CSSSplitWebpackPluginFix";

class CSSSplitWebpackPluginFix extends CSSSplitWebpackPlugin {
  apply(compiler) {
          ...
          compilation.hooks["processAssets"].tapAsync(
            {
              name,
              stage:
                compilation.constructor["PROCESS_ASSETS_STAGE_OPTIMIZE_COUNT"],
...
module.exports = CSSSplitWebpackPluginFix;
